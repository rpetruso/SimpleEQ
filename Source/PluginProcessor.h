...
#include <array>
template<typename T>
struct Fifo  // Fifo that Gui thread can retrieve blocks of data from SingleChannelSampleFifo
{
...
template<typename BlockType> // collects samples of data into fixed blocks so can be processed by fft
...
//                *leftLowCut.template get<3>().coefficients = *cutCoefficients[0];  // old code
